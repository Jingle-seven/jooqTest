...
public class SpanTopoTest implements Serializable {

    private static final long serialVersionUID = 1346288731;
    ...
    public SpanTopoTest(SpanTopoTest value) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("SpanTopoTest (");
