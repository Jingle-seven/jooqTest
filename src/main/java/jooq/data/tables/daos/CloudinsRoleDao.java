...
public class CloudinsRoleDao extends DAOImpl<CloudinsRoleRecord, jooq.data.tables.pojos.CloudinsRole, Long> {
     ...
     */
    @Override
    protected Long getId(jooq.data.tables.pojos.CloudinsRole object) {
        return object.getId();
    }
     ...
     */
    public List<jooq.data.tables.pojos.CloudinsRole> fetchById(Long... values) {
     ...
     */
    public jooq.data.tables.pojos.CloudinsRole fetchOneById(Long value) {
