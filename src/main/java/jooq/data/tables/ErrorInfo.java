...
public class ErrorInfo extends TableImpl<ErrorInfoRecord> {
     ...
     */
    public static final ErrorInfo ERROR_INFO = new ErrorInfo();
     ...
     */
    public ErrorInfo(String alias) {
        this(alias, ERROR_INFO);
    }

    private ErrorInfo(String alias, Table<ErrorInfoRecord> aliased) {
        this(alias, aliased, null);
    }

    private ErrorInfo(String alias, Table<ErrorInfoRecord> aliased, Field<?>[] parameters) {
     ...
     */
    @Override
    public ErrorInfo as(String alias) {
        return new ErrorInfo(alias, this);
    }

    /**
     * Rename this table
     */
    public ErrorInfo rename(String name) {
        return new ErrorInfo(name, null);
    }
}
